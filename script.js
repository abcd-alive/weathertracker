...
document.addEventListener('DOMContentLoaded', () =>{
  ...
  constprevButton = document.getElementById('prev-button')
  prevButton.addEventListener('click',() => handlePrev())

  requestNotificationPermission() //This will ask the user notification! :
})
...
const getForecast = (location) => {
  ...
  let selecedForecast = mockForecast[locationKey]
  // mockForecast.locationKey

  forecastData = selecedForecast
...
const displayMockForecast = (forecast, index) => {
  ...
  //use weather to determine image, default to sunny image otherwise
  forecastImage.src = `./images/${currForecast?.weather.toLowerCase()}.jpg`
}
